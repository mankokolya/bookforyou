...
insert into book values (1, 'Java 7: A Beginner''s Guide, Fifth Edition will have you programming in Java right away. ',
                         '10 September 2011', 'Java. A Beginner''s Guid');
insert into book values (2, 'When the Knight Bus crashes through the darkness and screeches to a halt in front of him, ' ||
                            'it''s the start of another far from ordinary year at Hogwarts for Harry Potter. ',
                         '20 November 2015', 'Harry Potter and the Prisoner of Azkaban');
insert into book values (3, 'Java 7: A Beginner''s Guide, Fifth Edition will have you programming in Java right away. ',
                         ' 16 Мая 2016', 'Приключения Гекльберри Финна');
insert into book values (4, 'Winter is coming. Such is the stern motto of House Stark, the northernmost of the fiefdoms ' ||
                         ...
                         '14 August 2003', 'A Game of Thrones');
...
insert into book values (6, 'Повесть-сказка о добром докторе Айболите и его удивительных приключениях в Африке, ' ||
                         ...
                         '10 декабря 1999', 'Доктор Айболит');
insert into book values (7, 'Гарри Поттера ждёт самое страшное испытание в жизни — смертельная схватка с Волан-де-Мортом.' ||
                         ...
                         '21 Февраля 2007', 'Гарри Поттер и Дары Cмерти');
insert into book values (8, 'Whether you''re a beginner or an experienced pro, you''ll ' ||
                         ...
                         '05 November 2007', 'Herb Schildt''s Java Programming Cookbook');
