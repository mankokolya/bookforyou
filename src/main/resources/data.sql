...
INSERT INTO users(id, email, first_name, last_name, password, account_id)
VALUES (1, 'mankokolya@gmail.com', 'Mykola', 'Manko', '$2y$12$3/SLz8PouovfM/CqC.nOt.wOXzSwSkq7WKZ8DVuTL0D/lTL0c6m5y', 1);

INSERT INTO users(id, email, first_name, last_name, password, account_id)
VALUES (2, 'manko@gmail.com', 'Mykola', 'Manko', '$2y$12$3/SLz8PouovfM/CqC.nOt.wOXzSwSkq7WKZ8DVuTL0D/lTL0c6m5y', 2);
...
values (1, 'Pottermore Publishing'); --Harry Porter
INSERT INTO publisher
values (2, 'McGraw-Hill Education'); --Java 7
INSERT INTO publisher
values (3, 'Азбука'); --Гекльбери Фин, Кобзар, Доктор Айболит
INSERT INTO publisher
values (4, 'Bantam'); --Thrones
INSERT INTO publisher
values (5, 'РОСМЭН'); --Гарри Потер
INSERT INTO publisher
values (6, 'Брайт Букс'); --Богатий тато


insert into book(id, description, published_date, quantity, title, publisher_id)
values (1,
...
--INSERT AUTHOR
insert into author
values (1, 'J. K. Rowling');--harry porter children/fantasy
insert into author
values (2, 'Марк Твен'); --фин children
insert into author
values (3, 'Herbert Schildt');
insert into author
values (4, 'Чуковский Корней Иванович');--children
insert into author
values (5, 'George R. R. Martin');--thrones fantasy
insert into author
values (6, 'Тарас Шевченко');
insert into author
values (7, 'Роберт Т. Кійосакі');
--children
